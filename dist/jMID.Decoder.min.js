 ...
 * MIT Licensed
 */
var jMID=function(g){var j=function(b){var a=new g.Event;a.set("deltaTime",b.readVarInt());var c=b.readInt8(),d=g.EventTypes;if(240==(c&240))switch(c){case d.META:a.set("type","meta");var e=b.readInt8(),c=b.readVarInt(),d=g.SubEventTypes,f;for(f in d){var h=d[f];if(e==h){switch(h){case d.SEQUENCE_NUMBER:a.set("number",b.readInt16());break;case d.MIDI_CHANNEL_PREFIX:a.set("channel",b.readInt8());break;case d.SET_TEMPO:a.set("microsecondsPerBeat",(b.readInt8()<<16)+(b.readInt8()<<8)+b.readInt8());a.set("subtype",
...
data:b.read(c)});break;default:a.set({subtype:"unknown",data:b.read(c)})}break}}break;case d.SYSEX:a.set("type","sysex");e=b.readVarInt();a.set("data",b.read(e));break;case d.DIVIDED_SYSEX:event.set("type","dividedSysex");b=stream.readVarInt();event.set("data",stream.read(b));break;default:throw Error("Unrecognized event");}else for(e in h=c,c=g.SubEventTypes,0==(h&128)?(f=h,h=this._lastEventType):(f=b.readInt8(),this._lastEventType=h),d=h>>4,a.set("channel",h&15),a.set("type","channel"),c)if(h=c[e],
d==h)switch(h){case c.NOTE_OFF:a.set("noteNumber",f);a.set("subtype","noteOff");a.set("velocity",b.readInt8());break;case c.NOTE_ON:a.set("noteNumber",f);a.set("subtype","noteOn");a.set("velocity",b.readInt8());0==a.get("velocity")&&a.set("subtype","noteOff");break;case c.NOTE_AFTER_TOUCH:a.set("noteNumber",f);a.set("subtype","noteAfterTouch");a.set("amount",b.readInt8());break;case c.CONTROLLER:a.set("subtype","controller");a.set("controllerType",f);a.set("value",b.readInt8());break;case c.PROGRAM_CHANGE:a.set("subtype",
"programChange");a.set("programNumber",f);break;case c.CHANNEL_AFTER_TOUCH:a.set("subtype","channelAfterTouch");a.set("amount",f);break;case c.PITCH_BEND:a.set("subtype","pitchBend"),a.set("coarse",f),a.set("fine",b.readInt8()),a.set("value",a.coarse+(a.fine<<7))}return a},i=function(b){var a=b.read(4),c=b.readInt32();return{id:a,length:c,data:b.read(c)}};g.Decoder=function(){};g.Decoder.prototype={decode:function(b){for(var a=i(b),c=new g.Stream(a.data),d=c.readInt16(),a=c.readInt16(),e=c.readInt16(),
c=[],d={format:d,trackCount:a,ticksPerBeat:e},e=0;e<a;e++){c[e]=new g.Track;for(var f=i(b),f=new g.Stream(f.data);!f.eof();)c[e].pushEvent(j.call(this,f))}return new g.File({header:d,tracks:c})}};g.Emitter&&g.Emitter.register(g.Decoder);return g}(jMID||{});
