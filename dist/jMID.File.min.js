...
6E7/this.timing.MicroSPB*(this.timeSignature.beatValue/4)},getHeader:function(){return this.header},encode:function(){return(new c.Encoder).encode(this)},base64Encode:function(){return btoa(this.encode())}};return c}(jMID||{});
