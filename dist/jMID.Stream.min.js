...
this.index+=1;return a&&127<b?b-256:b},eof:function(){return this.index>=this.string.length},readVarInt:function(){for(var a=0;;){var b=this.readInt8();if(b&128)a+=b&127,a<<=7;else return a+b}}};return c}(jMID||{});
