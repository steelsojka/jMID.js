...
INSTRUMENT_NAME:4,LYRICS:5,MARKER:6,CUE_POINT:7,jMID_CHANNEL_PREFIX:32,END_OF_TRACK:47,SET_TEMPO:81,SMPTE_OFFSET:84,TIME_SIGNATURE:88,KEY_SIGNATURE:89,SEQUENCER_SPECIFIC:127,NOTE_OFF:8,NOTE_ON:9,NOTE_AFTER_TOUCH:10,CONTROLLER:11,PROGRAM_CHANGE:12,CHANNEL_AFTER_TOUCH:13,PITCH_BEND:14};return e}(jMID||{}),jMID=function(e){var b=function(){for(var a,b=arguments,c=b.length,e;c&&this.length;)for(a=b[--c];-1!==(e=this.indexOf(a));)this.splice(e,1);return this},a=function(a){for(var b=a.split(",").map(function(a){return a.trim()}),
a=[],c=0,e=b.length;c<e;c++)a.push(b[c].split(" "));b=[];c=0;for(e=a.length;c<e;c++)for(var g=a[c],f=0,s=this._results.tracks.length;f<s;f++){var r=this._results.tracks[f];b.push([]);for(var p=0,t=r.length;p<t;p++){for(var m=r[p],k=!1,o=0,u=g.length;o<u;o++){var n;a:{n=g[o];for(var i=[":",">",">=","<","<="],h=i.length-1;0<=h;h--)if(-1!==n.search(i[h])){n=i[h];break a}n=void 0}h=g[o].split(n);i=h[0];h=h[1];switch(n){case ":":k=m[i]==h;break;case ">":k=m[i]>h;break;case ">=":k=m[i]>=h;break;case "<":k=
m[i]<h;break;case "<=":k=m[i]<=h}if(!k)break}k&&b[f].push(m)}}return{tracks:b}},c=function(a,b){this._results=b?b:{tracks:a.tracks.slice(0)};this._decoder=a};c.prototype={filter:function(b){b=a.call(this,b);return new c(this._decoder,b)},remove:function(d){for(var d=d?a.call(this,d):this._results,e=0,q=d.tracks.length;e<q;e++)b.apply(this._decoder.tracks[e],d.tracks[e]);return new c(this._decoder)}};e.Query=function(a){if(!a)throw Error("Midi is needed for querying");return new c(a)};return e}(jMID||
{}),jMID=function(e){var b="C ;C#;D ;D#;E ;F ;F#;G ;G#;A ;A#;B ".split(";");e.Converter=function(){this.setType(e.Converter.Types.NOTE_TO_FREQUENCY)};e.Converter.prototype={noteToFrequency:function(a){return 0<=a&&119>=a?440*Math.pow(2,(a-69)/12):-1},noteToName:function(a){return 0<=a&&119>=a?(b[a%12]+Math.round(a/12).toString()).replace(/\s+/g,""):"---"},frequencyToNote:function(a){return Math.round(12*(Math.log(a/440)/Math.log(2)))+69},nameToNote:function(a){var c,d,e;if(2===a.length)d=a[0]+" "+
a[1];else if(2<a.length)return-1;d.toUpperCase();a=-1;c=0;for(e=b.length;c<e;c++)if(b[c]===d[0]+d[1]){a=c;break}try{return c=parseInt(d[2],10),12*c+a}catch(q){return-1}},convert:function(a){switch(this._type){case 0:return this.noteToFrequency(a);case 1:return this.noteToName(a);case 2:return this.frequencyToNote(a);case 3:return this.nameToNote(a)}},setType:function(a){this._type=a}};e.Converter.Types={NOTE_TO_FREQUENCY:0,NOTE_TO_NAME:1,FREQUENCY_TO_NOTE:2,NAME_TO_NOTE:3};return e}(jMID||{});
